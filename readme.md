...
### 3.1 Find relationship between motor command & real output of Dynamixel
...
### 3.2 Find relationship between the values generated by the robot and the values of Wheel Odometry.
...
### 3.4 Motion Following at different scenario
