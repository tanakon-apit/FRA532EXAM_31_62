...
data = pd.read_csv('/home/tanakon/FRA532EXAM_31_62_WS/half_circle.csv')
...
x4 = (np.array(data['ground_x']) - 6.068770e-2) * 0.929008008169053

y4 = (np.array(data['ground_y']) - 6.588850e-1) * 0.91784356538233
